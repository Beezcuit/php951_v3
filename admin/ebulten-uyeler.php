...
if(isset($_POST['guncelle'])){
    ...
    if($guncelle->rowCount()){
        echo '<script>alert("Üye Maili Güncellendi")</script><meta http-equiv="refresh" content="0; url=uyeler.php">';
    } else {
        echo '<script>alert("Hata Oluştu")</script><meta http-equiv="refresh" content="0; url=uyeler.php">';
    }
}
?>
