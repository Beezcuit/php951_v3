            ...
            <div class="card-body">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    <td> <a href="../makale.php?postID=<?php echo $sonYazilarRow['id']; ?>" target="_blank" class="text-dark">
                                            <?php echo $sonYazilarRow['baslik']; ?>
                                        </a>
                                    </td>
                                    <td class="text-end">
                                        <a href="yazilar.php?updateID=<?php echo $sonYazilarRow['id']; ?>" target="_blank" class="text-dark">Düzenle</a>
                                    </td>
                                </tr>
                        <?php
                            }
