...
<section id="banner<?php echo $id; ?>" class="banner" style="background: url(<?php echo substr($hizmetRow['gorsel'],1); ?>);">
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <h1><?php echo $hizmetRow['baslik']; ?></h1>
                <small><a href="index.php" class="text-dark">Ana Sayfa</a> / <?php echo $hizmetRow['baslik']; ?></small>
