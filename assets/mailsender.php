...
try {
    ...
    $mail->Username   = 'ayberkozkan92@gmail.com';        // Gönderici mail adresi
    $mail->Password   = 'vjrx yjcc otyq rqsl';            // Şifre (Gmail için uygulama şifresi gerekebilir)
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;   // Şifreleme türü
    $mail->Port       = 587;                              // SMTP portu

    // Alıcılar
    $mail->setFrom('ayberkozkan92@gmail.com', 'Ayberk Özkan');
    $mail->addAddress('alicimail@example.com', 'Ayberk 2');
